...
export const ScanFoodPage = () => {
  ...
  const handleManualAdd = async () => {
    ...
    const entry = createFoodEntry({
      name: trimmedName,
      calories: Number.isFinite(calories) && calories > 0 ? calories : estimateCaloriesFromName(trimmedName),
  ...
  return (
    <div className="space-y-5 pb-24">
      ...
      <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
        <CardShell>
          <p className="text-sm uppercase tracking-[0.24em] text-black">Today's Intake</p>
